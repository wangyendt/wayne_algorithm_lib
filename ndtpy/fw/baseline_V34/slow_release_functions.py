...
def calculate_I_rules(rawData, baseline, max_ch):
    ...
    n1, n2, n3, n4 = 2, 2, 2, 2
    max_ch_b_1 = a1 < A_TH / n1 and b1 < B_TH / n1 and c1 < 0.7 and d1 < -10 and rawData[-1, max_ch] < rawData[
        -2, max_ch]
    min_ch_b_1 = a2 < A_TH / n1 and b2 < B_TH / n1 and c2 < 0.7 and d2 < -10 and rawData[-1, min_ch] < rawData[
        -2, min_ch]

    if max_ch_b:
        # print('strong', max_ch)
        # print(a1,b1,c1,d1)
        return 2.01  # strong rule
    elif min_ch_b:
        # print('strong', max_ch)
        # print(a2,b2,c2,d2)
        return 2.02
