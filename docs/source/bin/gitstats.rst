...
命令运行成功后，会在 ``--save`` 指定的路径生成一张紧凑的 Seaborn 风格统计图。默认画布为 11×7.2 英寸；图表标题、坐标轴和星期均使用中文，并自动检测系统中可用的中文字体：
...
- 中文仍显示为方框：脚本会依次检测苹方、微软雅黑、Noto/思源黑体、文泉驿、黑体等常见字体；若系统未安装其中任何一种，请先安装一款中文字体后重试。
